            ...
            if (this.hasPermission(this.getPermission(), sender)) {
                ...
                resetConversation.afterConversationEnded((result) -> {
                    if (result.wasSuccessful()) {
                        ...
                        } else if (resetType.equalsIgnoreCase(ResetConversationType.RESET_ACTIVE_PROGRESS)) {
                            this.plugin.getPathManager().resetProgressOnActivePaths(uuid);
                ...
                this.plugin.getServer().getScheduler().runTaskAsynchronously(this.plugin, () -> resetConversation.startConversationAsSender(sender));
            }
