...
public class TimeDailyRequirement extends AbstractRequirement {
    ...
    public TimeDailyRequirement() {
    }

    public String getDescription() {
        return Lang.TIME_DAILY_REQUIREMENT.getConfigValue(AutorankTools.timeToString(this.timeNeeded, TimeUnit.MINUTES));
    }
    ...
    public String getProgressString(UUID uuid) {
        ...
        try {
            playtime = this.getAutorank().getPlayTimeManager().getPlayTime(TimeType.DAILY_TIME, uuid).get();
